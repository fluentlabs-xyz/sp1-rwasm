...
use super::{
    columns::{BinOp32Cols, I32_LEN, NUM_BINOP32_MEM_COLS},
    trace::{BYTE_MASK, PRODUCT_SIZE},
    BinOp32Chip,
};
use crate::{
    air::{SP1AirBuilder, SubAirBuilder, WordAirBuilder, WORD_SIZE},
    bytes::ByteOpcode,
    memory::MemoryCols,
    operations::AddOperation,
    runtime::{Opcode, SyscallCode},
};
use num::zero;
