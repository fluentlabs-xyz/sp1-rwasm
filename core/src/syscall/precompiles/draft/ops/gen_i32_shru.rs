...
impl<'a, F: PrimeField32> OpcodeTrace<'a, "I32Shru", F> for OpcodeTraceBuilder<'a, F> {
...
impl OpcodeExecute<"I32Shru"> for OpcodeExecuteBuilder {
    fn opcode_specific(&mut self) -> i32 {
        (self.x_val >> self.y_val) as i32
    }
}
